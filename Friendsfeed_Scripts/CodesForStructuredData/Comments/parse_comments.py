...
#The script first removes the stop words and saves of the root form of every token onto another file
...
output_file = open("./commentfinal.csv","w")
count = 0
with open("./commentAugSeptout.csv") as f1:
    for line in f1:
        count += 1
        if(count % 100000 == 0):
            print count
